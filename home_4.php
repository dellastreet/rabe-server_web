...
$query = "SELECT *, status_name FROM rabedb_request INNER JOIN rabedb_status ON request_status = status_id WHERE request_status != 1 AND request_organisation = 4;";
...
echo "<p><input type='button' onClick=javascript:location.href='all_requests_".$_SESSION['userOrganisation'].".php' id='allRequests' name='allRequests' value=' view all requests '> | <input type='button' onClick=javascript:location.href='live_image_download.php' id='liveImageDownload' name='liveImageDownload' value=' download default live image '></p>";
